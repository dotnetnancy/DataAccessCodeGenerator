...
namespace CodeSampleApplication.Bo.List
{
    ...
    public class Person_Address : List<CodeSampleApplication.Dto.Person_Address>
    {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, CodeSampleApplication.Bo.Person_Address filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                CodeSampleApplication.Dto.Person_Address dto = ((CodeSampleApplication.Dto.Person_Address)(filledBo));
                List<CodeSampleApplication.Dto.Person_Address> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        CodeSampleApplication.Bo.Person_Address boToFill = new CodeSampleApplication.Bo.Person_Address();
        ...
        public virtual void FillByPrimaryKey(CodeSampleApplication.Bo.Person_Address filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(CodeSampleApplication.Bo.Person_Address filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(CodeSampleApplication.Bo.Person_Address filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(CodeSampleApplication.Bo.Person_Address filledBo)
        {
