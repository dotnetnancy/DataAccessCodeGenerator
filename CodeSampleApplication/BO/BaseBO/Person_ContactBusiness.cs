...
namespace CodeSampleApplication.Bo
{
    ...
    public class Person_Contact : CodeSampleApplication.Dto.Person_Contact
    {
        ...
        private void FillPropertiesFromBo(CodeSampleApplication.Bo.Person_Contact filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(CodeSampleApplication.Dto.Person_Contact filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                CodeSampleApplication.Dto.Person_Contact dto = _baseBusiness.FillDtoWithThis(this);
                CodeSampleApplication.Dto.Person_Contact returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                CodeSampleApplication.Dto.Person_Contact dto = _baseBusiness.FillDtoWithThis(this);
                CodeSampleApplication.Dto.Person_Contact returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                CodeSampleApplication.Dto.Person_Contact dto = _baseBusiness.FillDtoWithThis(this);
                CodeSampleApplication.Dto.Person_Contact returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                CodeSampleApplication.Dto.Person_Contact dto = this;
                List<CodeSampleApplication.Dto.Person_Contact> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
