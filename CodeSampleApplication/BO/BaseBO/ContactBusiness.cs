...
using CommonLibrary.Base.Database;
    ...
    public class Contact : CodeSampleApplication.Dto.Contact
    {        
        ...
        public Contact(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings, CodeSampleApplication.Bo.Contact filledBo)
        {
            _databaseSmoObjectsAndSettings = databaseSmoObjectsAndSettings;
            _baseDataAccess = 
                new CommonLibrary.Base.Database.BaseDataAccess<CodeSampleApplication.Dto.Contact>(_databaseSmoObjectsAndSettings);
        ...
        private void FillPropertiesFromBo(CodeSampleApplication.Bo.Contact filledBo)
        {
        ...
        public virtual void Insert()
        {
            if (this.BaseDataAccessAvailable())
            {
                ...
                CodeSampleApplication.Dto.Contact returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                CodeSampleApplication.Dto.Contact dto = _baseBusiness.FillDtoWithThis(this);
                CodeSampleApplication.Dto.Contact returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
